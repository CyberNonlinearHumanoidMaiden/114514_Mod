...
NGame = {
	...
	LAG_DAYS_FOR_PAUSE = 300,						-- Days of client lag for pause of gamespeed.
    GAME_SPEED_SECONDS = { 100.0, 0.5, 0.2, 0.05, 0.0 }; -- SPEED 4 IS 0.1 IN VANILLA  game speeds for each level. Must be 5 entries with last one 0 for unbound
...
NCountry = {
	...
	REINFORCEMENT_MANPOWER_DELIVERY_SPEED = 20.0,	-- Modifier for army manpower reinforcement delivery speed (travel time)
...
NNavy = {
	...
	INITIAL_ALLOWED_DOCKYARD_RATIO_FOR_REPAIRS = 1.0,				-- initially countries will allocate this ratio of dockyards for repairs
